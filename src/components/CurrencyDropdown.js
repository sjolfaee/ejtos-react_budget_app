    ...
    return (
        ...
        >
            ...
            >
                ...
                <option className="currencyOption" value={USD}>{USD} Dollar </option>
                <option className="currencyOption" value={EUR}>{EUR} Euro</option>
                <option className="currencyOption" value={GBP}>{GBP} Pound</option>
                <option className="currencyOption" value={INR}>{INR} Ruppee</option>
            </select>
        </div>
